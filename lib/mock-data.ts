...
export const mockProperty: Property = {
  ...
  description:
    "Casa Elody es una villa privada frente al mar en la costa de Galicia, a un paseo de las playas de Os Castros y As Catedrais. Grandes ventanales abiertos al Atlántico, terraza exterior con vistas ininterrumpidas y un jardín privado hasta el acantilado hacen de esta casa un refugio pensado para desconectar. Dentro, espacios luminosos y una cocina completa invitan a alargar las sobremesas con los productos y vinos de la tierra; fuera, el sonido del mar marca el ritmo de los días. El punto de partida perfecto para descubrir la gastronomía y los paisajes de Galicia.",
  address: "Camiño do Faro, 8",
  city: "Rías Altas, Galicia",
  lat: 43.5590,
  lng: -7.2062,
  price_per_night: 180,
  cleaning_fee: 50,
